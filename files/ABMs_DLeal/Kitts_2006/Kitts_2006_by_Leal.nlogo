...
@#$#@#$#@
<experiments>
  <experiment name="fig_3_full_granularity_reps=30_negative_incentive_on" repetitions="30" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <metric>participation</metric>
    <enumeratedValueSet variable="negative-incentive?">
      <value value="true"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="enf">
      <value value="2"/>
    </enumeratedValueSet>
  ...
  <experiment name="fig_2_&amp;_3_negative_incentive_full_granularity_reps=30" repetitions="30" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>participation</metric>
  ...
  <experiment name="experiment_phase_diagram" repetitions="50" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <metric>participation</metric>
    ...
    <steppedValueSet variable="lambda" first="0" step="0.2" last="1"/>
    <enumeratedValueSet variable="initial-cooperation">
      <value value="0"/>
      <value value="50"/>
      <value value="100"/>
    ...
    <steppedValueSet variable="mu" first="0" step="2" last="40"/>
  ...
  <experiment name="experiment_phase_diagram_90" repetitions="50" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <metric>participation</metric>
