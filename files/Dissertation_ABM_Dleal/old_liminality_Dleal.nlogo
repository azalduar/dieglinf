...
972
673
Note: The original versions of this model is based on empirical data from Add Health. Since those data are protected to protected the identity of the participants, the network used in this model is a random network based on Add Health data. To see results based on the empirical data, please contact Diego F. Leal\n
11
0.0
1
